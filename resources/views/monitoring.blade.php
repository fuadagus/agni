...
@section('content')
<div id="map" style="width: 100vw; height: 86vh; margin: 0"></div>
    ...
    var firePoint = L.geoJson(null, {
        onEachFeature: function (feature, layer) {
            var popupContent = "Temperatur IF4: " + feature.properties.brightness + "<br>" +
                ...
                "Kepercayaan: " + feature.properties.confidence + "<br>";
    ...
    var point = L.geoJson(null, {
        onEachFeature: function (feature, layer) {
            var popupContent = "Name: " + feature.properties.name + "<br>" +
                ...
                "<a href='{{ url('edit-point') }}/" + feature.id + "' class='btn btn-xs h-2 btn-warning me-2'><i class='fa-solid fa-edit'></i></a>" +

                "<form action='{{ url('delete-point') }}/" + feature.id + "' method='POST'>" +
                '{{ csrf_field() }}' +
                '{{ method_field('DELETE') }}' +
